...
cp -r /isibhv/netscratch/miseq/M03457_0137_000000000-L2MMN/ /isibhv/projects/FRAMdata/MolObs/WaterCol_CTD_PS138/
'''
...
#remove Undetermined from sample lsit !
# Rename / remove MiSeq run-ID 
#rename 'M03457_0137_000000000-L2MMN' 'L2MMN' *
cd L2MMN
mkdir Original 
cd M03457_0149_000000000-L95YW
mv *gz ../M03457_0137_000000000-L2MMN/
cd "/isibhv/projects/FRAMdata/MolObs/WaterCol_CTD_ICE_PS138/L2MMN/"
cd M03457_0137_000000000-L2MMN
mv *gz ../Original
...
###### remove samples that were re-sequenced ########
...
"
# Merge
seqtab_raw <- mergeSequenceTables(
  sq1, sq2, repeats="error")

#Samples rerun in L95YW(sq3), to be removed from sq1, sq2
#List of samples to be removed
samples_to_remove <- c("PS138-113-1-CTD-10-16S_clip", 
                       "PS138-115-1-CTD-1000-16S_clip", 
                       "PS138-115-1-CTD-1500-16S_clip", 
                       "PS138-115-1-CTD-3000-16S_clip", 
                       "PS138-115-1-CTD-4275-16S_clip", 
                       "PS138-115-1-CTD-500-16S_clip", 
                       "PS138-143-1-CTD-500-16S_clip", 
                       "PS138-168-01-CTD-1500-16S_clip", 
                       "PS138-175-1-CTD-50-16S_clip")

# Remove samples from seqtab_raw
seqtab_medium <- seqtab_raw[!(rownames(seqtab_raw) %in% samples_to_remove),]

seqtab <- mergeSequenceTables(
  seqtab_medium,sq3, repeats="error")
